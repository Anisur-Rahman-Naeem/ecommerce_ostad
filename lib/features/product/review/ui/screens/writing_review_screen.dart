...
class _WritingReviewScreenState extends State<WritingReviewScreen> {
  ...
  final WritingReviewController _writingReviewController = Get.find<WritingReviewController>();
  @override
  ...
  Future<void> _writeReview() async {
    final bool result = await Get.find<WritingReviewController>().writeReview(widget.productId, _writingReviewController.rating.value, _commentTEController.text);
    if (result) {
